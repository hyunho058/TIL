...
for b in bookTypeList:
    ...
    # for f in bestseller_contents:
    #     print(f.find('input', {'name':'barcode'}))
    ...
    # barcode_list = [b.find('input', {'name':'barcode'}).get('value') for b in input_list]
    ...
    for i in range(len(title_list)):
        ...
        print(bsObject.select('span.name a')[0].text)
        print(input_list[i])
        # print(barcode_list[i])
